 ...
 * JsonataEditor
 *
 * An instance of CodeMirror for editing JSONata string defined in QueryEditor.
 *
 * Props:
 *
 ...
 *
 */
export class JsonataEditor extends React.Component<JsonataEditorProps> {
  CodeMirror: any;
  ...
  componentDidUpdate(prevProps: JsonataEditorProps) {
    this.CodeMirror = require('codemirror');
    if (!this.editor) {
      return;
    }
