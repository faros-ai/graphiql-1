...
export declare class GraphiQL extends React.Component<GraphiQLProps, GraphiQLState> {
    ...
    getJsonataEditor(): import("codemirror").Editor | null;
    ...
    handleEditJsonata: (value: string) => void;
    ...
    handleSelectHistoryQuery: (query?: string | undefined, variables?: string | undefined, jsonata?: string | undefined, headers?: string | undefined, operationName?: string | undefined) => void;
    ...
    private handleOpenJsonataEditorTab;
